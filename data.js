...
const VENUES = [
  ...
  },
  {
    ...
    "featured": false,
    "addressUnverified": true,
    "note": "NLH〜Mix対応・Webコイン制。曜日固定の毎週パターンではなく、月替わりのカレンダー画像で毎月告知(2026年9月のカレンダーで、月曜=フリーロール/火曜=FREEZE OUT+FST5.0サテライトは概ね続くものの、金曜のJOPT福岡サテライトは1度も開催されず、月内でも例外日(9/21月・9/29火など)がある月替わり告知タイプと判明)。日曜定休ではない(9/6・9/27にSPADIE店舗DAY1やFREE ROLLが日曜開催された実績あり)。最新の日程は、店舗が毎月投稿するカレンダーでご確認ください。住所の部屋番号「2F-A」は公式Instagram(@sky_minoshima)で直接確認できておらず未確認情報です(2026-09-09時点)。ご来店前に公式SNSでご確認ください。",
    "sourceLabel": "Instagram",
