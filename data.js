...
const VENUES = [
  ...
  { id: 'v21', name: 'KENポーカー（久留米）',                        area: '久留米', address: '福岡県久留米市東町34-71',                    access: '西鉄久留米駅 徒歩5分',         x: '',                               line: '', instagram: 'https://www.instagram.com/kurume_ken_poker/', website: '',                                 tel: '080-3904-2698', featured: false, note: '営業18:00-24:00・初心者講習あり。JOPT/WJPT・MASAKICHI SUPER LEAGUE系。卓状況はオープンチャットで更新中。住所/電話はポーカー店ディレクトリ情報のため要確認。' },
];
