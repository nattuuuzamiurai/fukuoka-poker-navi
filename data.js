...
const VENUES = [
  ...
  { id: 'v21', name: '憲法家（久留米）',                            area: '久留米', address: '',                                          access: '久留米市（要確認）',           x: '',                               line: '', instagram: '',                                          website: '',                                 tel: '',             featured: false, note: 'ユーザー提供の月間予定表より登録。店名・住所・SNSは要確認（JOPT/WJPT・MASAKICHI SUPER LEAGUE系）。卓状況はオープンチャットで更新中とのこと。' },
];
