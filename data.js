...
const VENUES = [
  ...
  },
  {
    ...
    "note": "営業継続を確認済み(2026-07-14)。住所は第三者媒体(light-three.com等)による情報で公式SNSでの一次確認が取れておらず未確認。定休日は不明(2026年7月・8月のカレンダーはいずれも月・火曜とも営業実績あり。旧note「月・火曜定休」は2026年7月カレンダーからの推測記載だったが、その後の月も含め実態と矛盾するため2026-08-18に削除)。通常リングゲームは比較的リーズナブルな価格帯で、ハイレベル志向のウェブコインリングも用意。条件付きで出前無料サービスを利用できる場合がある。営業時間は第三者媒体情報のため要確認。",
    "sourceLabel": "X",
  ...
  },
  {
    ...
    "featured": false,
    "note": "カジノバー。2026年9月の公式X投稿で火・木曜に「DAILY TOURNAMENT」の開催を確認(時間・詳細は非公開、来店前にスタッフへ要確認)。投稿時点で9月後半の日程は未公開。グレー基調の洗練されたラグジュアリーな内装で、入場料に飲み放題が含まれる。初心者・女性にも人気。営業時間は第三者媒体情報のため要確認。",
    "sourceLabel": "X",
