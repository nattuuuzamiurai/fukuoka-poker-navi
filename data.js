...
const VENUES = [
  ...
  },
  {
    ...
    "featured": false,
    "addressUnverified": true,
    "note": "ポーカー専門スポット。入場1,000円(飲み放題込)、トーナメント1,000円〜。住所は要確認。公式サイトURL「https://alice2174.com/73162/」は静岡県富士市の無関係な別店舗を指していたため削除(2026-09-09品質管理部が実地確認)。正しい公式サイトURLは要再確認。",
    "sourceLabel": "",
    "sourceUrl": ""
  },
  {
  ...
  },
  {
    ...
    "addressUnverified": true,
    "closed": true,
    "note": "本格リング+フリーロールトーナメント開催(会員制からコンセプト変更の可能性あり・要現地確認)。住所(建物名「プレイスポットしんばし別館8階」)は第三者媒体(oncasimonster.jpの記事、検索スニペット経由で直接フェッチ未了)による情報のため要確認。閉店した可能性があります(要確認)。",
    "sourceLabel": "",
    "sourceUrl": "",
    "ring": true,
