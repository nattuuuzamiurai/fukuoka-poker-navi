...
const VENUES = [
  ...
  },
  {
    ...
    "featured": false,
    "note": "入場1,000円飲み放題。毎週固定の曜日別トーナメントスケジュールあり(月〜日で内容が決まっている)。中洲エリアで駅直結レベルの好立地。仕事帰りや夜遊びの流れでも立ち寄りやすい夜型のポーカースポット。営業時間は第三者媒体情報のため要確認。",
    "sourceLabel": "X",
  ...
  },
  {
    ...
    "tel": "",
    "featured": false,
    "note": "テキサスホールデム専門。営業時間は第三者媒体情報のため要確認。",
    "sourceLabel": "",
    "sourceUrl": ""
  },
  {
  ...
  },
  {
    ...
    "note": "営業継続を確認済み(2026-07-14)。住所は第三者媒体(light-three.com等)による情報で公式SNSでの一次確認が取れておらず未確認。定休日は不明(2026年7月・8月のカレンダーはいずれも月・火曜とも営業実績あり。旧note「月・火曜定休」は2026年7月カレンダーからの推測記載だったが、その後の月も含め実態と矛盾するため2026-08-18に削除)。福岡最安値クラスの通常リングゲームに加え、ハイレベル志向のウェブコインリングも用意。プレイ中は出前無料サービスあり。営業時間は第三者媒体情報のため要確認。",
    "sourceLabel": "X",
  ...
  },
  {
    ...
    "featured": false,
    "note": "カジノバー。2026年9月の公式X投稿で火・木曜に「DAILY TOURNAMENT」の開催を確認(時間・詳細は非公開、来店前にスタッフへ要確認)。投稿時点で9月後半の日程は未公開。ラグジュアリーな内装が特徴で、入場料に飲み放題が含まれる。グレー基調の洗練された内装で初心者・女性にも人気。営業時間は第三者媒体情報のため要確認。",
    "sourceLabel": "X",
  ...
  },
  {
    ...
    "featured": false,
    "note": "『オルカ』主催トーナメント毎日。ポーカーだけでなくダーツや30種類以上のボードゲームも楽しめるアミューズメントバー。貸切イベントやポーカーテーブルレンタルにも対応。営業時間は第三者媒体情報のため要確認。",
    "sourceLabel": "公式LINE",
  ...
  },
  {
    ...
    "featured": false,
    "note": "リング/トーナメント両方。テキサスホールデム専門のアミューズメントポーカールーム。禁煙環境で、ギャンブル行為やチップ換金は行わず純粋にアミューズメントとして楽しめる運営方針。",
  ...
  },
  {
    ...
    "featured": false,
    "note": "RFID導入の本格ポーカールーム。ハイローラー等イベント定期開催。中洲エリア最大級のポーカースポット。NLH・PLO・MIXなど幅広いゲーム種に対応。営業時間は第三者媒体情報のため要確認。",
    "sourceLabel": "X",
  ...
  },
  {
    ...
    "featured": false,
    "note": "2025/12開店。DJL(店内リーグ戦)・FPC・FSTサテライト・ミステリーバウンティ等を定期開催。「SUPER DOJO RING DAY」はリングゲーム企画のため掲載対象外。トーナメント・リングゲームともに活発に開催される大型ポーカースポット。初心者講習にも対応。営業時間は第三者媒体情報のため要確認。",
    "sourceLabel": "X",
  ...
  },
  {
    ...
    "featured": false,
    "addressUnverified": true,
    "note": "NLH〜Mix対応・Webコイン制。低価格設定と充実したゲームラインナップで、初心者から通いやすい明るい雰囲気。曜日固定の毎週パターンではなく、月替わりのカレンダー画像で毎月告知(2026年9月のカレンダーで、月曜=フリーロール/火曜=FREEZE OUT+FST5.0サテライトは概ね続くものの、金曜のJOPT福岡サテライトは1度も開催されず、月内でも例外日(9/21月・9/29火など)がある月替わり告知タイプと判明)。日曜定休ではない(9/6・9/27にSPADIE店舗DAY1やFREE ROLLが日曜開催された実績あり)。最新の日程は、店舗が毎月投稿するカレンダーでご確認ください。住所の部屋番号「2F-A」は公式Instagram(@sky_minoshima)で直接確認できておらず未確認情報です(2026-09-09時点)。ご来店前に公式SNSでご確認ください。",
    "sourceLabel": "Instagram",
