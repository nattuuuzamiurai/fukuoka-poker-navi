 ...
 *   「14日」表記のコメント3箇所を直し忘れ、品質チェックの指摘で差し戻しになった(PR #67)。
...
test('本番のBIG_EVENTS: 2026-09-01時点でFST 5.0が掲載ウィンドウに入る(運営判断・30日化の意図どおり)', () => {
...
// ============================================================
test('SHOW_CUTOFF_HOURは6である(運営判断・2026-09-06。巻き戻り検知用)', () => {
