 ...
 *   「14日」表記のコメント3箇所を直し忘れ、公開前チェックの指摘で修正した(2026-09-01)。
...
test('本番のBIG_EVENTS: 2026-09-01時点でFST 5.0が掲載ウィンドウに入る(30日化の意図どおり)', () => {
...
// ============================================================
test('SHOW_CUTOFF_HOURは6である(2026-09-06変更。巻き戻り検知用)', () => {
