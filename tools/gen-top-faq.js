 ...
 *
 * 【なぜこのファイルがあるか】
 *   GEO(Generative Engine Optimization)監査(2026-09-03)で、FAQPageスキーマが
 ...
 *
 * 【FAQの内容について】
 *   質問・回答は事実確認済み(コンテンツ制作 geo-content-draft-2026-09.md・2026-09-03)。
 ...
 *   運営が2026-09-03にGitHub Actions実行履歴で追加確認済み(ドラフト参照)。
...
const TOP_FAQ_ITEMS = [
  ...
  },
  {
    ...
    aHtml: '<a href="contact.html">お問い合わせフォーム</a>の「お問い合わせ種別」で「掲載内容の誤り・修正依頼」を選び、誤りの内容をご記入のうえ送信してください。運営者が確認し、必要に応じて掲載内容を修正します。',
    aText: 'お問い合わせフォームの「お問い合わせ種別」で「掲載内容の誤り・修正依頼」を選び、誤りの内容をご記入のうえ送信してください。運営者が確認し、必要に応じて掲載内容を修正します。'
  },
  {
    q: 'このサイトは大会の公式情報ですか？',
  ...
  // 【2026-09-13新設・マーケティング分析】Search Console実測で「福岡 ポーカー」の
  // インプレッションが実質0件だったことを踏まえ、「店を選ぶための紹介記事」という検索意図の
  // 受け皿である初心者向けガイド(/guide/beginner/)への内部リンクを兼ねて追加する。
  {
    q: '初めてで、どの店に行けばいいか分かりません。',
    aHtml: '福岡のポーカー店の選び方(トーナメント重視・リングゲーム・お酒重視など目的別のおすすめ、初心者講習ありの店舗紹介)をまとめた<a href="guide/beginner/">初心者向けガイド</a>をご用意しています。エリアや目的に応じてお店を探したい方はそちらもご覧ください。',
    aText: '福岡のポーカー店の選び方(トーナメント重視・リングゲーム・お酒重視など目的別のおすすめ、初心者講習ありの店舗紹介)をまとめた初心者向けガイドページをご用意しています。エリアや目的に応じてお店を探したい方はそちらもご覧ください。'
  },
  // 【2026-09-14新設・開発対応】2025年12月の警視庁一斉調査を受けた「ウェブコイン」規制解説記事
  // (/guide/webcoin-regulation/、企画/コンテンツ制作の原稿にもとづく)への内部リンクを兼ねる。
  // 記事本文は特定店舗を評価しない立場のため、ここでも店舗名・店舗ページへのリンクは含めない。
  {
    q: '「ウェブコイン」って最近ニュースで見ましたが、大丈夫なんですか？',
    aHtml: '2025年12月、警視庁がアミューズメントカジノ店舗を一斉調査し、風営法違反が確認されたと報じられました。「ウェブコイン」の何が問題視されているのか、2026年に入ってからの動きも含めて<a href="guide/webcoin-regulation/">こちらの解説記事</a>で整理しています。当サイトは特定店舗・サービスの合法性を判定・保証するものではないため、最新の状況は公的機関・各サービス運営元の公式発表もあわせてご確認ください。',
    aText: '2025年12月、警視庁がアミューズメントカジノ店舗を一斉調査し、風営法違反が確認されたと報じられました。「ウェブコイン」の何が問題視されているのか、2026年に入ってからの動きも含めて解説記事で整理しています。当サイトは特定店舗・サービスの合法性を判定・保証するものではないため、最新の状況は公的機関・各サービス運営元の公式発表もあわせてご確認ください。'
  }
];
