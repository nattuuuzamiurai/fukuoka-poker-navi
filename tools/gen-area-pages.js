...
// ---- エリア紹介文(依頼: PV向上ロードマップ「エリア×ポーカー複合キーワード対策」・企画部/コンテンツ制作部) ----
// 【背景】店舗一覧+アクセス駅名の機械的な列挙だけで、エリアそのものを説明する文章が無かった。
//   狙いは「天神 ポーカー」「中洲 ポーカー」等の地名+ポーカー複合キーワードでの検索順位向上。
// 【原稿の出どころ】コンテンツ制作部が area-content-brief.md(2026-09-08)で作成。地理・特徴の記述は
//   同ファイルに記載のWebSearch出典に基づく。店舗数・所在地・最寄駅は data.js の VENUES から集計済み。
//   ★地理的事実(エリアの特徴・最寄駅関係等)は品質管理部での裏取り確認が前提。
