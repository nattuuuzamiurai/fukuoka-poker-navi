...
const CATEGORIES = [
  ...
  },
  {
    ...
    // 【2026-09-18・v28 について】v28(CasinoX)は店舗公式Xの告知(2026年5月)でリングゲームの開催と
    // レートが確認でき data.js で ring:true になった(それ以前から本カテゴリーの chips には
    // 掲載済み。扱いは v2 と同じで chips のまま)。
    featured: [],
    // 【2026-09-18・v23 を削除、v26 を追加】v23(ALICE the Poker room)は臨時休業中で再開の見込みが
    // 立っていないとの情報により data.js で closed:true(要確認)にした。v30 と同じ理由で本カテゴリー
  ...
  },
  {
    ...
    // 【2026-09-18・v23(ALICE the Poker room)を削除】臨時休業中で再開の見込みが立っていないとの
    // 情報により data.js で closed:true にしたため、v30 と同じ理由で外した(入場料の記述も第三者媒体
    // 由来で当サイト未確認だった)。
    featured: [
