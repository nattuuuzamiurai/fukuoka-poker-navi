 ...
 *
 * 【何を守っているか】
 *   1. 一致した行だけが消えること(曜日ごと全滅させない = レビューが名指しで禁じた実装)
 ...
 *   追加した時点(2026-07-30)では正しかった(自動取込は v3 の1店だけで、その店に RECURRING が無かった)。
 ...
 *   (venue-schedule.test.js が採っている方針と同じ)。
 *
...
test('曜日ごと全滅させない: 取込が無い曜日の定期開催は残る（レビューが名指しで禁じた実装の再発防止）', () => {
