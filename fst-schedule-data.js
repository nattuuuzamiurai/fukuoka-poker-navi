...
// 取得日: 2026-09-01 / 開発部
//
// 注1: entry が null の行(MAIN EVENT / FST Championship の各Day1フライト、計10行)は、
//      PDF上のENTRY欄が数値ではなくアイコン/バッジ表記になっており、当方では本文から具体的な
//      金額を読み取れなかった行。金額を推測で埋めていない。画面上は「PDF未記載」であることが
//      分かる表現にし、既存の const FST.events[]（MAIN EVENT/CHAMPIONSHIPの概要）へ誘導する
//      (index.html の fstEntryText() を参照)。
...
const FST_SCHEDULE = {
  ...
  { day:"2026-09-19", no:"1", start:"11:30", close:"17:10", name:"Main Event Day1A", entry:null, series:null, flight:"MAIN_DAY1" },
  ...
  { day:"2026-09-19", no:"1", start:"17:30", close:"21:50", name:"Main Event Day1B", entry:null, series:null, flight:"MAIN_DAY1" },
  ...
  { day:"2026-09-20", no:"1", start:"11:30", close:"17:10", name:"Main Event Day1C", entry:null, series:null, flight:"MAIN_DAY1" },
  { day:"2026-09-20", no:"14", start:"12:00", close:"16:30", name:"Deep Stack", entry:20000, series:null },
  { day:"2026-09-20", no:"1", start:"17:30", close:"21:50", name:"Main Event Day1D", entry:null, series:null, flight:"MAIN_DAY1" },
  ...
  { day:"2026-09-21", no:"1", start:"10:00", close:"12:30", name:"Main Event Day1E -After R5 Day2-", entry:null, series:null, flight:"MAIN_DAY1" },
  ...
  { day:"2026-09-21", no:"22", start:"14:00", close:"19:40", name:"FST Championship Day1A", entry:null, series:null, flight:"CHAMP_DAY1" },
  ...
  { day:"2026-09-21", no:"22", start:"20:00", close:"23:40", name:"FST Championship Day1B", entry:null, series:null, flight:"CHAMP_DAY1" },
  ...
  { day:"2026-09-22", no:"22", start:"11:30", close:"17:10", name:"FST Championship Day1C", entry:null, series:null, flight:"CHAMP_DAY1" },
  ...
  { day:"2026-09-22", no:"22", start:"17:30", close:"21:50", name:"FST Championship Day1D", entry:null, series:null, flight:"CHAMP_DAY1" },
  ...
  { day:"2026-09-23", no:"22", start:"10:00", close:"11:40", name:"FST Championship Day1E -After R5 Day2-", entry:null, series:null, flight:"CHAMP_DAY1" },
